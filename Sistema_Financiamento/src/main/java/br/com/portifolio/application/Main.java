...
import br.com.portifolio.service.EmprestimoService;
        ...
        do {
            ...
            switch (opcao) {
                ...
                case (1) -> {//Menu de cliente
                    ...
                    System.out.println("5 - Atualizar dados de um cliente");
                    ...
                    while (opcao != 99) {
                        ...
                        switch (opcao) {
                            ...
                            case (3) -> {
                                PessoaService.imprimirListaPessoa();
                            }
                            case (4) -> {
                                try {
                                    System.out.print("Informe o cpf/cnpj do cliente a ser deletado.: ");
                                    String id = scanner.next();
                            ...
                            case (5) -> {
                                System.out.println("============Atualização de dado cadastral============");
                                try{
                                    pessoa = instanciarPessoa(scanner);
                ...
                case (2) -> {//Menu de emprestimo
                    ...
                    do {
                        ...
                        switch (opcao) {
                            ...
                            case (11) -> {
                                System.out.print("Informe o CPF/CNPJ do cliente para pesquisar os emprestimos: ");
                                String id = scanner.next();
                                EmprestimoService.imprimirEmprestimosByPessoa(id);
                            }
